...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public DatabaseHelper(Context context, String database_name, SQLiteDatabase.CursorFactory cursor_factory, int database_version, String[] database_tables, String[] table_fields) {
        ...
        File aware_folder = new File( docs, "AFFECTIVA" ); //create an AWARE folder if it doesn't exist
    ...
    public SQLiteDatabase getWritableDatabase() {
        ...
        File database_file = new File( mContext.getExternalFilesDir(null)+ "/Documents/AFFECTIVA/" , database_name );
        try {
